...
\item 
DECLSPEC char $\ast$SDLCALL \mbox{\hyperlink{_s_d_l__filesystem_8h_a752d42a2e7fbff1292b7e54593be37bc}{SDL\+\_\+\+Get\+Base\+Path}} (void)
\item 
DECLSPEC char $\ast$SDLCALL \mbox{\hyperlink{_s_d_l__filesystem_8h_ab11eaf74d913eefb472475f0c8e312ce}{SDL\+\_\+\+Get\+Pref\+Path}} (const char $\ast$org, const char $\ast$app)
...
{\bfseries{Nintendo 3DS Specific Functionality}}\+: This function returns \char`\"{}romfs\char`\"{} directory of the application as it is uncommon to store resources outside the executable. As such it is not a writable directory.
...
an absolute path in UTF-\/8 encoding to the application data directory. NULL will be returned on error or when the platform doesn\textquotesingle{}t implement this functionality, call \mbox{\hyperlink{_s_d_l__error_8h_ac88e1aa404a8f94aaee4ad6b94547647}{SDL\+\_\+\+Get\+Error()}} for more information.
\end{DoxyReturn}
\begin{DoxySince}{Since}
This function is available since SDL 2.\+0.\+1.
\end{DoxySince}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{_s_d_l__filesystem_8h_ab11eaf74d913eefb472475f0c8e312ce}{SDL\+\_\+\+Get\+Pref\+Path}} 
\end{DoxySeeAlso}
...
You should assume the path returned by this function is the only safe place to write files (and that \mbox{\hyperlink{_s_d_l__filesystem_8h_a752d42a2e7fbff1292b7e54593be37bc}{SDL\+\_\+\+Get\+Base\+Path()}}, while it might be writable, or even the parent of the returned path, isn\textquotesingle{}t where you should be writing things).
...
\end{DoxySince}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{_s_d_l__filesystem_8h_a752d42a2e7fbff1292b7e54593be37bc}{SDL\+\_\+\+Get\+Base\+Path}} 
\end{DoxySeeAlso}
